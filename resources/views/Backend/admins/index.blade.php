 					...
 					<table id="example1" class="table key-buttons text-md-nowrap text-center">
						 ...
						 @foreach ($admins as $admin)
 							<tr>
 								...
 								<td>
                                    {{-- @can('مشاهدة مستخدم') --}}
                                    <a class="btn btn-success btn-sm" href="/employee/{{$admin->id}}"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                    {{-- @endcan --}}
                                    {{-- @can('تعديل مستخدم') --}}
                                    <a class="btn btn-primary btn-sm" href="/employee/{{$admin->id}}/edit"><i class="fa fa-edit" aria-hidden="true"></i></a>
                                    {{-- @endcan --}}
                                 </td>
 							</tr>
						 @endforeach
